...
- **Conflict prevention** refuses a booking if that gym is already reserved or blocked. The same slot cannot be double booked, and a team cannot hold the same day and time at two different gyms at once.
