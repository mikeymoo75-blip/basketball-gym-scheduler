...
async function main() {
  ...
  const bookings: {
    ...
    { gym: "Godwin", userId: devon.id, dayOffset: 0, startHour: 18, hours: 2, notes: "Varsity skill work" },
    { gym: "Highland 1", userId: devon.id, dayOffset: 1, startHour: 17, hours: 2, notes: "Full-court press" },
    { gym: "MP High School 1", userId: devon.id, dayOffset: 2, startHour: 18, hours: 2, notes: "Zone breakdown" },
    { gym: "Eastern Christian", userId: devon.id, dayOffset: 3, startHour: 17, startMinute: 30, hours: 2, notes: "Shooting circuit" },
    { gym: "Godwin", userId: devon.id, dayOffset: 7, startHour: 18, hours: 2, notes: "Film + walkthrough" },
    { gym: "Highland 2", userId: devon.id, dayOffset: 8, startHour: 17, hours: 2, notes: "Scrimmage" },
    { gym: "MP High School 2", userId: devon.id, dayOffset: 9, startHour: 18, hours: 2, notes: "Conditioning" },
    { gym: "Godwin", userId: marcus.id, dayOffset: 0, startHour: 16, hours: 1.5, notes: "Freshman fundamentals" },
    { gym: "Highland 2", userId: marcus.id, dayOffset: 2, startHour: 16, hours: 1.5 },
    { gym: "Eastern Christian", userId: aisha.id, dayOffset: 1, startHour: 19, hours: 1.5, notes: "Guard development" },
    { gym: "Highland 1", userId: aisha.id, dayOffset: 4, startHour: 10, hours: 2, notes: "Saturday clinic" },
    { gym: "MP High School 2", userId: jen.id, dayOffset: 3, startHour: 16, hours: 1.5, notes: "JV walkthrough" },
    { gym: "Godwin", userId: jen.id, dayOffset: 10, startHour: 16, hours: 1.5 },
  ];
