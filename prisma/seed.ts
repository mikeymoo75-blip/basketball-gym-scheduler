...
async function main() {
  ...
  const bookings: {
    ...
    { gym: "Highland Gym Far Side", userId: devon.id, dayOffset: 8, startHour: 17, hours: 1, notes: "Scrimmage" },
    { gym: "Highland Gym Far Side", userId: devon.id, dayOffset: 8, startHour: 18, hours: 1, notes: "Scrimmage" },
    ...
    { gym: "Highland Gym Far Side", userId: marcus.id, dayOffset: 2, startHour: 16, hours: 1 },
